...
// Categorie di segnalazione (public.building_reports.category) — separate
// dalle recensioni: qui si segnala un problema puntuale, non si valuta.
export const REPORT_CATEGORIES = [
  { value: 'noise', label: 'Rumore' },
  { value: 'maintenance', label: 'Manutenzione' },
  { value: 'security', label: 'Sicurezza' },
  { value: 'infiltration', label: 'Infiltrazioni / umidità' },
  { value: 'elevator', label: 'Ascensore' },
  { value: 'cleaning', label: 'Pulizia' },
  { value: 'heating', label: 'Riscaldamento' },
  { value: 'common_areas', label: 'Parti comuni' },
  { value: 'pests', label: 'Infestazioni' },
  { value: 'waste', label: 'Rifiuti' },
